...
const Register = () => {
  ...
  return (
    <div className="w-full px-4 md:px-auto relative">
      <div className="hidden md:block">
        <Lottie loop={false} play animationData={lottieUser} />;
      </div>
      <form
        className="md:absolute top-5 left-0 right-0 border md:min-w-[28rem] mx-auto md:max-w-[32rem] p-4 w-full md:py-5 md:px-20 bg-slate-300/90 dark:bg-slate-700/90 border-slate-400 dark:border-slate-600 rounded-md"
